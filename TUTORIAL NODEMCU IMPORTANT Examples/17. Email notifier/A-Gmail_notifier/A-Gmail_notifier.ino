...
int getUnread() {    // A function to get the number of unread emails in your Gmail inbox
  WiFiClientSecure client; // Use WiFiClientSecure class to create a TLS (HTTPS) connection
  ...
  // Removed certificate verification
  Serial.println("No certificate verification performed");
